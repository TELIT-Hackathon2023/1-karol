...
def check_extension(link):
    for ext in ['.pdf', '.png', '.jpg', '.gif', '.doc', '.docx', '.xls', '.xlsx', '.txt']:
...
def get_domain_hyperlinks(local_domain, url):
    ...
    for link in set(get_hyperlinks(url)):
        ...
        if (clean_link is not None and not check_extension(clean_link)) or (
                clean_link is None and not check_extension(link)):
            print(f'EXCLUDED {clean_link}')
            continue
